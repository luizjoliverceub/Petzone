...
-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_veterinarianProfileId_fkey" FOREIGN KEY ("veterinarianProfileId") REFERENCES "VeterinarianProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_clientIdEmail_fkey" FOREIGN KEY ("clientIdEmail") REFERENCES "User"("email") ON DELETE RESTRICT ON UPDATE CASCADE;

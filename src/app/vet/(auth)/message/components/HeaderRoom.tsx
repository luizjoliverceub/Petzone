...
export function HeaderRoom({ id }: { id: string }) {
    ...
    return (
        <div className="py-4 px-6 flex gap-2 z-40 border-b-2 bg-white animate-fade-in">
            ...
            <div>
                {isLoading ?
                    ...
                    <div className="flex py-2 flex-col">
                        ...
                        <h3 className="text-xs font-semibold"><span className="text-zinc-500 font-medium text-xs">Contato:</span> {parseDate(data?.createdAt)}</h3>
                    </div>}
            </div>
        </div>
    )
